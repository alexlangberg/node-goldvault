...
var Db = function (bookshelf) {
  ...
  obj.models = {
    Source: obj.bookshelf.Model.extend({
      ...
      ensure: function (criteria) {
        return obj._ensure(obj.models.Source, this.attributes, criteria);
      }
    }),
...
Db.prototype._ensure = function (Model, instance, criteria) {
